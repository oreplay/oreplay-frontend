                ...
                <Toolbar sx={{display: "flex", justifyContent: "space-between"}}>
                    <Box>
                        <Tooltip title={t('StageHeader.Departures')}>
                            <IconButton color = {selectedMenu == 0 ? "secondary" : "primary"}  sx={{display: "flex", flexDirection: "column"}} 
                            onClick={() => {
                    ...
                    <Box>
                        <Tooltip title={t('StageHeader.Results')}>
                            <IconButton color = {selectedMenu == 1 ? "secondary" : "primary"} sx={{display: "flex", flexDirection: "column"}} 
                            onClick={
                                () => {
                    ...
                    <Box>
                        <Tooltip title={t('StageHeader.Splits')}>
                            <IconButton color = {selectedMenu == 2 ? "secondary" : "primary"} sx={{display: "flex", flexDirection: "column"}} 
                            onClick={() => {
