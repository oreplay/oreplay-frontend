...
export const STATUS_SCORE_FIELDS = [
  { index: 0, labelKey: "Ranking.Settings.statusScoresValues.ok" },
  { index: 1, labelKey: "Ranking.Settings.statusScoresValues.dns" },
  { index: 2, labelKey: "Ranking.Settings.statusScoresValues.dnf" },
  { index: 3, labelKey: "Ranking.Settings.statusScoresValues.mp" },
  { index: 4, labelKey: "Ranking.Settings.statusScoresValues.dqf" },
