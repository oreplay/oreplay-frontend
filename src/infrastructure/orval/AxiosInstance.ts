...
export const initAxiosClientInstance = (
  baseURL: string,
  headers: Record<string, string> = {},
) => {
...
export const getAxiosClientInstance = (): AxiosInstance => {
  if (!axiosClientInstance) {
    throw new Error(
      "Axios instance not initialized. Call initAxiosInstance first.",
    )
  }
...
export const updateAxiosClientHeaders = (
  headers: Record<string, string | undefined>,
) => {
  if (!axiosClientInstance) {
    throw new Error(
      "Axios instance not initialized. Call initAxiosClientInstance first.",
    )
  }
