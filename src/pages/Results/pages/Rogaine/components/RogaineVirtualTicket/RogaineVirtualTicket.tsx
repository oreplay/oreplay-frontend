 ...
 * @constructor
 */
const RogaineVirtualTicket: React.FC<VirtualTicketProps> = ({isTicketOpen,runner,handleCloseTicket}) => {
  ...
  if (runner) {
    return (
      ...
      >
        ...
        <VirtualTicketSplits>
          <Grid item xs={3}><Typography variant="subtitle2" sx={{fontWeight: 'bold', textAlign:'left'}}>{t('ResultsStage.VirtualTicket.Control')}</Typography></Grid>
          <Grid item xs={4}><Typography variant="subtitle2" sx={{fontWeight: 'bold', textAlign:'left'}}>{t('ResultsStage.VirtualTicket.Partial')}</Typography></Grid>
          <Grid item xs={5}><Typography variant="subtitle2" sx={{fontWeight: 'bold', textAlign:'left'}}>{t('ResultsStage.VirtualTicket.Cumulative')}</Typography></Grid>
          {
